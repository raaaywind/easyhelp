...
public class SOSReceiveMapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sosreceive_map);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_sosreceive_map, menu);
        return true;
    }
    ...
    private void initial() {
        ...
        sos = (Event) bundle.getSerializable("event");
    ...
    private void initialToolbar() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SOSReceiveMapActivity.this.finish();
            }
        });
    }
    ...
    private void initialMap() {
        ...
        // 设置地图显示求助事件要求的地点
        LatLng ll = new LatLng(sos.getLatitude(), sos.getLongitude());
